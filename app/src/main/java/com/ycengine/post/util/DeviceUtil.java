package com.ycengine.post.util;
...
public class DeviceUtil {
    ...
    public static int getStatusBarSize(Context context) {
        ...
        try {
            ...
            Timber.e("StatusBarHeight : " + StatusBarHeight);
            Timber.e("TitleBarHeight : " + TitleBarHeight);
        } catch (Exception e) {
    ...
    public static boolean isOnline(Context mContext) {
        ...
        if (mNetworkInfo != null) {
            if (mNetworkInfo.getType() == ConnectivityManager.TYPE_WIFI && mNetworkInfo.isConnectedOrConnecting()) {
                ...
                Timber.e("isOnline ▶ 모바일 네트워크 연결");
                PlayerConstants.MOBILE_NETWORK = true;
                return true;
            } else {
                Timber.e("isOnline ▶ 네트워크 오프라인");
                PlayerConstants.MOBILE_NETWORK = false;
                return false;
            }
        }
    ...
    public static void removeFiles(String path, String extension) {
        ...
        for (int i = 0; i < list.length; i++) {
            ...
            if (isDeleted) {
                Timber.e("파일 삭제 - " + file.getAbsolutePath());
            } else {
                Timber.e("파일을 삭제 중 실패하였습니다.");
            }
        }
    }
