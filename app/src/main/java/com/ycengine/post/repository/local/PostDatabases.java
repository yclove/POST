package com.ycengine.post.repository.local;
...
public class PostDatabases {
        ...
        if (Constants.DEBUG_DATABASE) {
            ...
            if (cursor .moveToFirst()) {
                ...
                do {
                    ...
                    Timber.e(columString.substring(0, columString.length() - 1) + "\n");
                } while (cursor.moveToNext());
            }
        }
    }
    ...
    public int updateOstPlayList(Object item, String... args) {
        ...
        Timber.e("DATABASE ▶ " + playerListAddPosition + " : " + TO_ADD_DATE + " : " + ADD_DATE);
